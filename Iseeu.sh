...
[+] GITHUB REPOSITORY: https://github.com/Maiake-ops/iseeu/
...
# Validate URL input
if [[ -z "$varurl" ]]; then
    echo "[!] Error: No URL provided. Type 1 to restart, 2 to exit."
...
if command -v python3 &>/dev/null; then
    ...
    SERVER_PID=$!
    echo "[+] Server started with ncat (Netcat) on http://localhost:8080"
else
